...
from Devices.tests.mocking.IndigoTrigger import IndigoTrigger
...
class Test_Shelly(unittest.TestCase):
    ...
    def test_getMessageType(self):
        ...
        self.assertEqual("some-type", self.shelly.getMessageType())

    def test_getMessageType_empty(self):
        self.assertEqual("", self.shelly.getMessageType())
    ...
    def test_getAnnounceMessageType_different(self):
        ...
        self.assertEqual("some-type", self.shelly.getMessageType())
        self.assertEqual("some-other-type", self.shelly.getAnnounceMessageType())
    ...
    def test_setTemperature(self):
        ...
        self.assertEqual(1, self.device.states_meta['temperature']['decimalPlaces'])
    ...
    def test_setTemperature_custom(self):
        ...
        self.assertEqual(3, self.device.states_meta['temp']['decimalPlaces'])
    ...
    def test_process_temperature_sensors_creates_correct_list(self):
        ...
        self.assertListEqual(expected, self.shelly.temperature_sensors)
    ...
    def test_process_humidity_sensors_creates_correct_list(self):
        ...
        self.assertListEqual(expected, self.shelly.humidity_sensors)
