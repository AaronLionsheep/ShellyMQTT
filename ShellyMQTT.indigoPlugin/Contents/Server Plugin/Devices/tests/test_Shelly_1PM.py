...
class Test_Shelly_1PM(unittest.TestCase):
    ...
    def test_handleMessage_energy(self):
        self.shelly.handleMessage("shellies/shelly1pm-test/relay/0/energy", "0")
    ...
    def test_handleMessage_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly1pm-test/relay/0/energy", "0A")
    ...
    def test_handleMessage_temperature_invalid(self):
        self.shelly.handleMessage("shellies/shelly1pm-test/temperature", "50A")

    def test_handleMessage_overtemperature(self):
        self.assertFalse(self.device.states['overtemperature'])
        self.shelly.handleMessage("shellies/shelly1pm-test/overtemperature", "1")
        self.assertTrue(self.device.states['overtemperature'])

        self.shelly.handleMessage("shellies/shelly1pm-test/overtemperature", "0")
        self.assertFalse(self.device.states['overtemperature'])

    def test_handleMessage_announce(self):
        announcement = '{"id": "shelly1pm-test", "mac": "aa:bb:cc:ee", "ip": "192.168.1.101", "fw_ver": "0.1.0", "new_fw": false}'
    ...
    def test_handleMessage_online_true(self):
        ...
        self.shelly.handleMessage("shellies/shelly1pm-test/online", "true")
    ...
    def test_handleAction_turn_on(self, publish):
        ...
        self.assertTrue(self.shelly.isOn())
        publish.assert_called_with("shellies/shelly1pm-test/relay/0/command", "on")
    ...
    def test_handleAction_turn_off(self, publish):
        ...
        self.assertTrue(self.shelly.isOff())
        publish.assert_called_with("shellies/shelly1pm-test/relay/0/command", "off")
    ...
    def test_handleAction_status_request(self, publish):
        ...
        publish.assert_called_with("shellies/shelly1pm-test/command", "update")
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_1PM.validateConfigUI(values, None, None)
