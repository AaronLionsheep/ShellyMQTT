...
class Test_Shelly_3EM_Meter(unittest.TestCase):
    ...
    def test_handleMessage_power_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/power", "Aa")
    ...
    def test_handleMessage_reactive_power_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/reactive_power", "Aa")
    ...
    def test_handleMessage_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "Aa")
    ...
    def test_handleMessage_returned_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "Aa")
    ...
    def test_handleMessage_voltage_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/voltage", "Aa")
    ...
    def test_handleMessage_current_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/current", "AA")
    ...
    def test_handleMessage_power_factor_invalid(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/pf", "AA")
    ...
    def test_updateStateImage_on(self):
        ...
        self.assertEqual(indigo.kStateImageSel.EnergyMeterOn, self.shelly.device.image)

    def test_updateStateImage_off(self):
        self.shelly.device.states['online'] = False
        self.shelly.updateStateImage()
        self.assertEqual(indigo.kStateImageSel.EnergyMeterOff, self.shelly.device.image)
