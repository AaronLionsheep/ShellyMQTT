...
class Test_Shelly_Bulb_Vintage(unittest.TestCase):
    ...
    def test_handleMessage_status_invalid(self):
        ...
        self.shelly.handleMessage("shellies/shelly-bulb-vintage-test/light/0/status", '{"ison": true, "mo')
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_Bulb_Vintage.validateConfigUI(values, None, None)
