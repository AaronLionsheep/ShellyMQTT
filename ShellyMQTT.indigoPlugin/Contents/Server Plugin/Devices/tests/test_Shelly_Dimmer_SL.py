...
class Test_Shelly_Dimmer_SL(unittest.TestCase):
    ...
    def test_handleMessage_status_invalid(self):
        ...
        self.shelly.handleMessage("shellies/shelly-dimmer-sl-test/light/0/status", '{"ison": true, "mo')
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_Dimmer_SL.validateConfigUI(values, None, None)
