...
class Test_Shelly_EM_Meter(unittest.TestCase):
    ...
    def test_handleMessage_power_invalid(self):
        self.shelly.handleMessage("shellies/shelly-em-meter-test/emeter/0/power", "Aa")
    ...
    def test_handleMessage_reactive_power_invalid(self):
        self.shelly.handleMessage("shellies/shelly-em-meter-test/emeter/0/reactive_power", "Aa")
    ...
    def test_handleMessage_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly-em-meter-test/emeter/0/energy", "Aa")
    ...
    def test_handleMessage_returned_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly-em-meter-test/emeter/0/returned_energy", "Aa")
    ...
    def test_handleMessage_voltage_invalid(self):
        self.shelly.handleMessage("shellies/shelly-em-meter-test/emeter/0/voltage", "Aa")
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_EM_Meter.validateConfigUI(values, None, None)
