...
class Test_Shelly_Plug_s(unittest.TestCase):
    ...
    def test_getSubscriptions(self):
        ...
        topics = [
            ...
            "shellies/shelly-plug-s-test/relay/0/overpower_value",
    ...
    def test_handleMessage_relay_overpower_value(self):
        """Test getting a relay overpower message."""
        self.shelly.handleMessage("shellies/shelly-plug-s-test/relay/0/overpower_value", "100.12")
    ...
    def test_handleMessage_energy_invalid(self):
        self.shelly.handleMessage("shellies/shelly-plug-s-test/relay/0/energy", "0A")
    ...
    def test_handleMessage_temperature_invalid(self):
        self.shelly.handleMessage("shellies/shelly-plug-s-test/temperature", "50A")
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_Plug_S.validateConfigUI(values, None, None)
