...
class Test_Shelly_2_5_Relay(unittest.TestCase):
    ...
    def test_getSubscriptions_channel_1(self):
        ...
        topics = [
            "shellies/announce",
            "shellies/shelly25relay-test/online",
    ...
    def test_handleMessage_relay_overpower(self):
        ...
        self.assertFalse(self.shelly.device.states['overpower'])
        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0", "overpower")
        self.assertTrue(self.shelly.device.states['overpower'])

    def test_handleMessage_relay_overpower_value(self):
        """Test getting a relay overpower message."""
        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0/overpower_value", "100.12")
    ...
    def test_handleMessage_longpush_on(self):
        ...
        self.shelly.handleMessage("shellies/shelly25relay-test/longpush/0", "1")
    ...
    def test_handleMessage_longpush_off(self):
        ...
        self.assertTrue(self.shelly.device.states['longpush'])
        self.shelly.handleMessage("shellies/shelly25relay-test/longpush/0", "0")
        self.assertFalse(self.shelly.device.states['longpush'])

    def test_handleMessage_power(self):
        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0/power", "0")
        ...
        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0/power", "101.123")
    ...
    def test_handleMessage_energy(self):
        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0/energy", "0")
        self.assertAlmostEqual(0.0000, self.shelly.device.states['accumEnergyTotal'], 4)

        self.shelly.handleMessage("shellies/shelly25relay-test/relay/0/energy", "50")
        self.assertAlmostEqual(0.0008, self.shelly.device.states['accumEnergyTotal'], 4)

    def test_handleMessage_temperature(self):
        self.shelly.handleMessage("shellies/shelly25relay-test/temperature", "50")
    ...
    def test_handleMessage_overtemperature(self):
        ...
        self.shelly.handleMessage("shellies/shelly25relay-test/overtemperature", "1")
        self.assertTrue(self.device.states['overtemperature'])

        self.shelly.handleMessage("shellies/shelly25relay-test/overtemperature", "0")
        self.assertFalse(self.device.states['overtemperature'])
    ...
    def test_handleAction_turn_on(self, publish):
        ...
        self.assertTrue(self.shelly.isOn())
        publish.assert_called_with("shellies/shelly25relay-test/relay/0/command", "on")
    ...
    def test_handleAction_turn_off(self, publish):
        ...
        self.assertTrue(self.shelly.isOff())
        publish.assert_called_with("shellies/shelly25relay-test/relay/0/command", "off")
    ...
    def test_handleAction_status_request(self, publish):
        ...
        publish.assert_called_with("shellies/shelly25relay-test/command", "update")
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_2_5_Relay.validateConfigUI(values, None, None)
