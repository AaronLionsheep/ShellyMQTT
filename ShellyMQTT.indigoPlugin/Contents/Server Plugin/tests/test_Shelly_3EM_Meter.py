...
class Test_Shelly_3EM_Meter(unittest.TestCase):
    ...
    def test_getSubscriptions(self):
        ...
        topics = [
            "shellies/announce",
            "shellies/shelly-3em-meter-test/online",
            "shellies/shelly-3em-meter-test/emeter/0/energy",
            "shellies/shelly-3em-meter-test/emeter/0/returned_energy",
            "shellies/shelly-3em-meter-test/emeter/0/power",
            "shellies/shelly-3em-meter-test/emeter/0/reactive_power",
            "shellies/shelly-3em-meter-test/emeter/0/voltage",
            "shellies/shelly-3em-meter-test/emeter/0/current",
            "shellies/shelly-3em-meter-test/emeter/0/pf",
            "shellies/shelly-3em-meter-test/emeter/0/total",
            "shellies/shelly-3em-meter-test/emeter/0/total_returned"
        ]
        self.assertListEqual(topics, self.shelly.getSubscriptions())

    def test_handleMessage_power(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/power", "0")
        ...
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/power", "101.123")
    ...
    def test_handleMessage_power_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/power", "Aa"))

    def test_handleMessage_reactive_power(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/reactive_power", "0")
        ...
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/reactive_power", "50.632")
    ...
    def test_handleMessage_reactive_power_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/reactive_power", "Aa"))

    def test_handleMessage_energy(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "0")
        self.assertAlmostEqual(0.0000, self.shelly.device.states['energy-consumed'], 4)

        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "50")
        self.assertAlmostEqual(0.0008, self.shelly.device.states['energy-consumed'], 4)

    def test_handleMessage_energy_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "Aa"))

    def test_handleMessage_returned_energy(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "0")
        self.assertAlmostEqual(0.0000, self.shelly.device.states['energy-returned'], 4)

        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "50")
    ...
    def test_handleMessage_returned_energy_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "Aa"))

    def test_handleMessage_total(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/total", "5")
        self.assertAlmostEqual(5.0, self.shelly.device.states['total-energy'], 1)

    def test_handleMessage_total_returned(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/total_returned", "6")
        self.assertAlmostEqual(6.0, self.shelly.device.states['total-returned-energy'], 1)

    def test_handleMessage_voltage(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/voltage", "120.12")
        ...
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/voltage", "122.87")
    ...
    def test_handleMessage_voltage_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/voltage", "Aa"))

    def test_handleMessage_current(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/current", "6.86")
        self.assertAlmostEqual(6.86, self.shelly.device.states['current'], 2)
        self.assertEqual("6.9 A", self.shelly.device.states_meta['current']['uiValue'])

    def test_handleMessage_current_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/current", "AA"))

    def test_handleMessage_power_factor(self):
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/pf", "12.86")
        self.assertAlmostEqual(12.86, self.shelly.device.states['power-factor'], 2)
        self.assertEqual("12.9", self.shelly.device.states_meta['power-factor']['uiValue'])

    def test_handleMessage_power_factor_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/pf", "AA"))

    def test_handleMessage_announce(self):
        announcement = '{"id": "shelly-3em-meter-test", "mac": "aa:bb:cc:ee", "ip": "192.168.1.101", "fw_ver": "0.1.0", "new_fw": false}'
    ...
    def test_handleMessage_online_true(self):
        ...
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/online", "true")
    ...
    def test_handleMessage_online_false(self):
        ...
        self.assertTrue(self.shelly.device.states['online'])
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/online", "false")
        self.assertFalse(self.shelly.device.states['online'])
    ...
    def test_handleAction_status_request(self, publish):
        ...
        publish.assert_called_with("shellies/shelly-3em-meter-test/command", "update")
    ...
    def test_updateEnergy_net_positive(self):
        ...
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "20")
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "50")
        # net of 30 consumed
        self.assertAlmostEqual(0.0005, self.shelly.device.states['accumEnergyTotal'], 4)
    ...
    def test_updateEnergy_net_negative(self):
        self.shelly.device.pluginProps['energy-display'] = "net"
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/returned_energy", "50")
        self.shelly.handleMessage("shellies/shelly-3em-meter-test/emeter/0/energy", "20")
        # net of 30 returned
        self.assertAlmostEqual(-0.0005, self.shelly.device.states['accumEnergyTotal'], 4)
        self.assertEqual("-0.0005 kWh", self.shelly.device.states_meta['accumEnergyTotal']['uiValue'])
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_3EM_Meter.validateConfigUI(values, None, None)
