...
class Test_Shelly_Plug(unittest.TestCase):
    ...
    def test_handleMessage_power(self):
        ...
        self.shelly.handleMessage("shellies/shelly-plug-test/relay/0/power", "101.123")
    ...
    def test_handleMessage_energy(self):
        self.shelly.handleMessage("shellies/shelly-plug-test/relay/0/energy", "0")
        self.assertAlmostEqual(0.0000, self.shelly.device.states['accumEnergyTotal'], 4)

        self.shelly.handleMessage("shellies/shelly-plug-test/relay/0/energy", "50")
        self.assertAlmostEqual(0.0008, self.shelly.device.states['accumEnergyTotal'], 4)

    def test_handleMessage_energy_invalid(self):
        self.assertRaises(ValueError, self.shelly.handleMessage("shellies/shelly-plug-test/relay/0/energy", "0A"))
    ...
    def test_handleAction_turn_on(self, publish):
        ...
        self.assertTrue(self.shelly.isOn())
        publish.assert_called_with("shellies/shelly-plug-test/relay/0/command", "on")
    ...
    def test_handleAction_turn_off(self, publish):
        ...
        self.assertTrue(self.shelly.isOff())
        publish.assert_called_with("shellies/shelly-plug-test/relay/0/command", "off")
    ...
    def test_handleAction_status_request(self, publish):
        ...
        publish.assert_called_with("shellies/shelly-plug-test/command", "update")
    ...
    def test_validateConfigUI(self):
        ...
        isValid, valuesDict, errors = Shelly_Plug.validateConfigUI(values, None, None)
